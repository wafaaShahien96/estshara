                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="roles[]" class="form-control">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="active">
                                    ...
                                    <option value="1" {{ old('active', $admin->active) == 1 ? 'selected' : ''}}>@lang('trans.active')</option>
                                    <option value="0" {{ old('active', $admin->active) == 0 ? 'selected' : ''}}>@lang('trans.inactive')</option>
